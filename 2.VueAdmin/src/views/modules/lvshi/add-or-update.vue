<template>
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="律师账号" prop="lvshizhanghao">
					<el-input v-model="ruleForm.lvshizhanghao" placeholder="律师账号" clearable  :readonly="ro.lvshizhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="律师账号" prop="lvshizhanghao">
					<el-input v-model="ruleForm.lvshizhanghao" placeholder="律师账号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="律师等级" prop="lvshidengji">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="律师等级" prop="lvshidengji">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="专业领域" prop="zhuanyelingyu">
					<el-select :disabled="ro.zhuanyelingyu" v-model="ruleForm.zhuanyelingyu" placeholder="请选择专业领域" >
						<el-option
							v-for="(item,index) in zhuanyelingyuOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="专业领域" prop="zhuanyelingyu">
					<el-input v-model="ruleForm.zhuanyelingyu"
						placeholder="专业领域" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="地区" prop="diqu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="地区" prop="diqu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="个人介绍" prop="gerenjieshao">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.gerenjieshao" label="个人介绍" prop="gerenjieshao">
                    <span :style='{"padding":"0 20px","color":"inherit","background":"none","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}' v-html="ruleForm.gerenjieshao"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				lvshidengji: [
					{ required: true, message: '律师等级不能为空', trigger: 'blur' },
				],
				touxiang: [
				],
				zhuanyelingyu: [
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gerenjieshao = this.ruleForm.gerenjieshao.replace(reg,'../../../springbooteozac1c1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
