...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px 0","margin":"20px 0 0","borderColor":"#ddd","alignItems":"center","flexWrap":"wrap","background":"none","borderWidth":"0 0 0px","display":"flex","width":"100%","borderStyle":"solid","height":"auto","order":"2"}'>
	  ...
	  <el-button v-if="btnAuth('falvxinwen','新增')" :style='{"cursor":"pointer","border":"0px solid #ddd","padding":"0px 15px","margin":"0px 0px 0 0","color":"#fff","display":"inline-block","outline":"none","borderRadius":"30px","background":"#1c6a6d","width":"90px","fontSize":"14px","lineHeight":"40px","height":"40px"}' type="primary" @click="add('/index/falvxinwenAdd')"><i v-if="false" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="sort_view" :style='{"padding":"10px 20px","margin":"26px 0 0","borderColor":"#3493c3","overflow":"hidden","borderRadius":"0px","textAlign":"right","background":"none","borderWidth":"0 0 3px","width":"100%","borderStyle":"solid","order":"3"}'>
		...
		<el-button :style='{"border":"0","padding":"0 5px","margin":"0 5px","borderRadius":"8px"}' @click="sortClick('thumbsupnum')">
			<span :style='{"margin":"0 2px 0 0","lineHeight":"40px","fontSize":"14px","color":"#929292"}' class="icon iconfont icon-xiaoliang13" v-if="sortType!='thumbsupnum'"></span>
			<span :style='{"margin":"0 2px 0 0","lineHeight":"40px","fontSize":"14px","color":"#929292"}' class="icon iconfont icon-jiantou23" v-else-if="sortType=='thumbsupnum'&&sortOrder=='desc'"></span>
			<span :style='{"margin":"0 2px 0 0","lineHeight":"40px","fontSize":"14px","color":"#929292"}' class="icon iconfont icon-jiantou24" v-else-if="sortType=='thumbsupnum'&&sortOrder=='asc'"></span>
			<span :style='{"color":"#929292","lineHeight":"40px","fontSize":"14px"}'>点赞数</span>
		</el-button>
	</div>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get(`falvxinwen/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        ...
        this.$router.push({path: '/index/falvxinwenDetail', query: params});
      },
