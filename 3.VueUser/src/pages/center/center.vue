...
<div class="center-preview" :style='{"padding":"20px 12% 40px","margin":"0 auto","color":"#999","flexWrap":"wrap","background":"#edeff1","display":"block","width":"100%","fontSize":"14px","position":"relative","justifyContent":"space-between"}'>
	...
	<div class="info" :style='{"padding":"80px 60px 80px 200px","margin":"20px 0 0 0","borderColor":"#28890b20","alignItems":"center","display":"flex","borderRadius":"0px","flexWrap":"wrap","background":"#fff","borderWidth":"0px","width":"calc(100% - 0px)","position":"relative","borderStyle":"solid","height":"auto","order":"2"}'>
		...
		<div :style='{"borderColor":"#1abc9e20","left":"20px","borderWidth":"0 0 0px 0","width":"auto","fontSize":0,"position":"absolute","borderStyle":"solid","height":"auto"}' v-if="userTableName=='lvshi'">
			<el-image :style='{"margin":"10px auto","borderColor":"#efefef","objectFit":"cover","borderRadius":"100%","borderWidth":"0 0 1px 0","display":"block","width":"150px","borderStyle":"solid","height":"150px"}' :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')" fit="cover"></el-image>
		</div>
		...
		<div :style='{"padding":"0 0px","borderColor":"#1abc9e20","margin":"0 5% 0 0","borderWidth":"0 0 0px 0","display":"block","width":"auto","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"inherit","margin":"0 10px 0 0","fontSize":"inherit"}'>状态</div>
			<div :style='{"fontSize":"inherit","color":"inherit","textAlign":"left","flex":1}'>{{sessionForm.status}}</div>
		</div>
		<div :style='{"padding":"0 0px","borderColor":"#1abc9e20","margin":"0 5% 0 0","borderWidth":"0 0 0px 0","display":"block","width":"auto","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='lvshi'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"width":"100%","margin":"0 10px 0 0","fontSize":"inherit","color":"inherit"}'>律师账号</div>
			<div :style='{"fontSize":"inherit","color":"inherit","textAlign":"left","flex":1}'>{{sessionForm.lvshizhanghao}}</div>
		</div>
		<div :style='{"padding":"0 0px","borderColor":"#1abc9e20","margin":"0 5% 0 0","borderWidth":"0 0 0px 0","display":"block","width":"auto","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='lvshi'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"inherit","margin":"0 10px 0 0","fontSize":"inherit"}'>律师姓名</div>
			<div :style='{"fontSize":"inherit","color":"inherit","textAlign":"left","flex":1}'>{{sessionForm.lvshixingming}}</div>
		</div>
		<div :style='{"padding":"0 0px","borderColor":"#1abc9e20","margin":"0 5% 0 0","borderWidth":"0 0 0px 0","display":"block","width":"auto","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='lvshi'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
		...
		<div :style='{"padding":"0 0px","borderColor":"#1abc9e20","margin":"0 5% 0 0","borderWidth":"0 0 0px 0","display":"block","width":"auto","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='lvshi'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"inherit","margin":"0 10px 0 0","fontSize":"inherit"}'>律师等级</div>
			<div :style='{"fontSize":"inherit","color":"inherit","textAlign":"left","flex":1}'>{{sessionForm.lvshidengji}}</div>
		</div>
		<div :style='{"padding":"0 0px","borderColor":"#1abc9e20","margin":"0","borderWidth":"0 0 0px 0","display":"block","width":"auto","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='lvshi'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"inherit","margin":"0 10px 0 0","fontSize":"inherit"}'>专业领域</div>
			<div :style='{"fontSize":"inherit","color":"inherit","textAlign":"left","flex":1}'>{{sessionForm.zhuanyelingyu}}</div>
		</div>
    ...
    <el-tabs tab-position="left" :style='{"width":"100%","margin":"20px 0 0","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="100px">
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="userTableName=='lvshi'" label="律师账号" prop="lvshizhanghao">
            <el-input v-model="sessionForm.lvshizhanghao" placeholder="律师账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="userTableName=='lvshi'" label="律师姓名" prop="lvshixingming">
            <el-input v-model="sessionForm.lvshixingming" placeholder="律师姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="userTableName=='lvshi'" label="年龄" prop="nianling">
            <el-input v-model="sessionForm.nianling" placeholder="年龄" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="userTableName=='lvshi'" label="性别" prop="xingbie">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="userTableName=='lvshi'" label="律师等级" prop="lvshidengji">
            <el-select v-model="sessionForm.lvshidengji" placeholder="请选择律师等级" >
              <el-option v-for="(item, index) in dynamicProp.lvshidengji" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="userTableName=='lvshi'" label="头像" prop="touxiang">
			<file-upload
			tip="点击上传头像"
			action="file/upload"
			:limit="1"
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="userTableName=='lvshi'" label="专业领域" prop="zhuanyelingyu">
            <el-select v-model="sessionForm.zhuanyelingyu" placeholder="请选择专业领域" >
              <el-option v-for="(item, index) in dynamicProp.zhuanyelingyu" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="userTableName=='lvshi'" label="地区" prop="diqu">
            <el-select v-model="sessionForm.diqu" placeholder="请选择地区" >
              <el-option v-for="(item, index) in dynamicProp.diqu" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="userTableName=='lvshi'" label="联系电话" prop="lianxidianhua">
            <el-input v-model="sessionForm.lianxidianhua" placeholder="联系电话" ></el-input>
          </el-form-item>
		  <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' v-if="userTableName=='lvshi'" label="个人介绍">
		    <editor
		        :style='{"minHeight":"250px","border":"0px solid #1abc9e30","outline":"none","color":"#333","borderRadius":"4px","background":"#fff","width":"100%","lineHeight":"32px","fontSize":"14px"}'
		        v-model="sessionForm.gerenjieshao" 
		        class="editor" 
		        action="file/upload">
		    </editor>
		  </el-form-item>
  ...
  export default {
    ...
    created() {
		...
		if ('lvshi' == this.userTableName) {
			this.$set(this.sessionForm, 'lvshizhanghao', null);
		}
		if ('lvshi' == this.userTableName) {
			this.$set(this.sessionForm, 'mima', null);
		}
		...
		if ('lvshi' == this.userTableName) {
			this.$set(this.sessionForm, 'lvshidengji', null);
		}
		if ('lvshi' == this.userTableName) {
			this.$set(this.sessionForm, 'touxiang', null);
		}
		...
		if ('lvshi' == this.userTableName) {
			this.$set(this.sessionForm, 'diqu', null);
		}
		if ('lvshi' == this.userTableName) {
			this.$set(this.sessionForm, 'lianxidianhua', null);
		}
		if ('lvshi' == this.userTableName) {
			this.$set(this.sessionForm, 'gerenjieshao', null);
		}
		if ('lvshi' == this.userTableName) {
		...
		if ('lvshi' == this.userTableName&&this.rules['lvshizhanghao']){
			this.rules['lvshizhanghao'].push({ required: true, message: '请输入律师账号', trigger: 'blur' })
		}else if('lvshi' == this.userTableName&&!this.rules['lvshizhanghao']) {
			this.$set(this.rules, 'lvshizhanghao', [{ required: true, message: '请输入律师账号', trigger: 'blur' }]);
		}
		if ('lvshi' == this.userTableName&&this.rules['mima']){
			this.rules['mima'].push({ required: true, message: '请输入密码', trigger: 'blur' })
		}else if('lvshi' == this.userTableName&&!this.rules['mima']) {
			this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
		}
		if ('lvshi' == this.userTableName&&this.rules['lvshixingming']){
			this.rules['lvshixingming'].push({ required: true, message: '请输入律师姓名', trigger: 'blur' })
		}else if('lvshi' == this.userTableName&&!this.rules['lvshixingming']) {
		...
		if ('lvshi' == this.userTableName&&this.rules['lvshidengji']){
			this.rules['lvshidengji'].push({ required: true, message: '请输入律师等级', trigger: 'blur' })
		}else if('lvshi' == this.userTableName&&!this.rules['lvshidengji']) {
			this.$set(this.rules, 'lvshidengji', [{ required: true, message: '请输入律师等级', trigger: 'blur' }]);
		}
		if ('lvshi' == this.userTableName) {
    ...
    methods: {
      init() {
        ...
        if ('lvshi' == this.userTableName) {
          this.dynamicProp.lvshidengji = '金牌律师,优秀律师,专业律师'.split(',');
        }
        if ('lvshi' == this.userTableName) {
          this.$http.get('option/zhuanyelingyu/zhuanyelingyu', {emulateJSON: true}).then(res => {
            if (res.data.code == 0) {
              this.dynamicProp.zhuanyelingyu = res.data.data;
			  this.$forceUpdate()
            }
          });
        }
        if ('lvshi' == this.userTableName) {
          this.$http.get('option/diquxinxi/diqu', {emulateJSON: true}).then(res => {
            if (res.data.code == 0) {
              this.dynamicProp.diqu = res.data.data;
			  this.$forceUpdate()
            }
          });
        }
