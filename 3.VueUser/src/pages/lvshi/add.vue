...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    <el-form
      ...
      label-width="150px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="律师账号" prop="lvshizhanghao">
            <el-input v-model="ruleForm.lvshizhanghao" 
                placeholder="律师账号" clearable :disabled=" false  ||ro.lvshizhanghao"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="律师姓名" prop="lvshixingming">
            <el-input v-model="ruleForm.lvshixingming" 
                placeholder="律师姓名" clearable :disabled=" false  ||ro.lvshixingming"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="律师等级" prop="lvshidengji">
            <el-select v-model="ruleForm.lvshidengji" placeholder="请选择律师等级" :disabled=" false  ||ro.lvshidengji" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="专业领域" prop="zhuanyelingyu">
            <el-select v-model="ruleForm.zhuanyelingyu" placeholder="请选择专业领域" :disabled=" false  ||ro.zhuanyelingyu" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="地区" prop="diqu">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="个人介绍" prop="gerenjieshao">
            <editor 
